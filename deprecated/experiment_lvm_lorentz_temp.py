...
def calc_metrics(device_idx, n_dim, n_nodes, n_graphs, n_devices, model_n_dims, target):
...
if __name__ == '__main__':
    ...
    for n_nodes in n_nodes_list:
        ...
        calc_metrics(device_idx=int(args.device), n_dim=int(args.n_dim),
                     n_nodes=n_nodes, n_graphs=10, n_devices=4, model_n_dims=model_n_dims, target=int(args.target))
